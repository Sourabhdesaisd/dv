...
// Pass by REFERENCE (task must be automatic to allow ref arguments)
module pass_by_ref;
  int a = 10, b = 5, result;
...
// Pass by CONST REF (read-only) - also automatic
...
//  Blocking task  (blocking call - caller waits)
...
// Non-blocking task (use fork/join_none)
module nonblocking_task;
